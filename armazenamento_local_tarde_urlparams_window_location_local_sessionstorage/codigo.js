...
const showDescription = (atleta) => {
    ...
    urlParams.set('nome_completo', atleta.nome_completo);
    urlParams.set('nascimento', atleta.nascimento);
    urlParams.set('altura', atleta.altura);
    urlParams.set('descricao', atleta.descricao);
    urlParams.set('imagem', atleta.imagem);
